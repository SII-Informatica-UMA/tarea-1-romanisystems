 ...
 */
package es.uma.informatica.sii.correctores.controladores;

import es.uma.informatica.sii.correctores.dtos.CorrectorDTO;
import es.uma.informatica.sii.correctores.entidades.Corrector;
import es.uma.informatica.sii.correctores.servicios.LogicaCorrectores;
...
public class CorrectorControlador {
    private LogicaCorrectores servicio;
    private ModelMapper modelMapper;

    @Autowired
    public CorrectorControlador(LogicaCorrectores service) {
